 ...
 */
class FrameClassToOptionsUpdate implements UpgradeWizardInterface, RepeatableInterface
{
    /**
     * @var string
     */
    ...
    {
        return '[Bootstrap Package] Migrate obsolete frame_class options to frame options';
    }
