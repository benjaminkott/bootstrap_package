...
class ImageVariantsViewHelper extends AbstractViewHelper
{
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('gutter', 'array', 'Gutter that needs to be respected when calculating responsive image widths', false);
    ...
    public static function renderStatic(
        ...
        $variants = ImageVariantsUtility::getImageVariants($arguments['variants'], $arguments['multiplier'], $arguments['gutter'], $arguments['corrections']);
