...
## BUGFIX
- [BUGFIX] Adapt link tag parsing for RTE fields 0535f530
- [BUGFIX] Correct changelog 2e5eacde

# 7.0.4

## TASK
- [TASK] Optimize travis and composer configuration for automatic ter uploading f61e3f8e
- [TASK] remove uniqueLinkVars (#407) 9ce35681
- [TASK] Use correct icons for tt_content imageorient palette - fixes #352 ae2ab9f6
- [TASK] Add changelog for release 7.0.0 5f7a5a84
- [TASK] Enable basic frontend editing 35df688f

## BUGFIX
- [BUGFIX] Use GeneralUtility to get instance of PageRenderer - fixes #412 781743f2
- [BUGFIX] Ensure that variables are not converted to strings by variable viewhelper 2819cc5c
- [BUGFIX] Use correct layout (#408) 1ed31987
- [BUGFIX] Enforce checkout with linux lf consistent over all plattforms 3b32f47b
- [BUGFIX] Respect show in section menus option for pages in section index menu 89295b7b
- [BUGFIX] Use generated title from menu processor instead of accessing the data directly - fixes #364 ea6e3712
- [BUGFIX] Backport menu processor adjustments, now includes spacer and generated links from hmenu - #364 228dbc77
- [BUGFIX] Fix tab elements missing on slided content 9eb3c1df
- [BUGFIX] Fix accordion elements missing on slided content a3d216dd
- [BUGFIX] Correct texticon content element rendering with default layout - fixes #336 dc8d537f
- [BUGFIX] Tabs, Accordion, and Carousel Items not referencing files on sys_file_reference and sys_refindex - fixes #349 70467bea
- [BUGFIX] Bugfix/menuprocessor (#354) 9914e8b6
- [BUGFIX] Correct php-cs-fixer command 48292c49
- [BUGFIX] Prevent double escaping of menu titles 3ec09517
- [BUGFIX] Remove vendor dir from php lint tests 5c162895
- [BUGFIX] Load form configuration only if ext:form is installed f1debae1

# 7.0.3

## TASK
- [TASK] Add missing css fixes for #325 4b1681f5

## BUGFIX
- [BUGFIX] Respect padding in equalheight script e8b6e56f
- [BUGFIX] Correct overlapping of content elements with indention - fixes #325 dfc538bc

# 7.0.2

## TASK
- [BUGFIX][REVERT][TASK] Remove unneeded rte_transform options ae39032b
