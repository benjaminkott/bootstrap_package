...
- [TASK] Add ddev setup a4977bfc
- [TASK] Drop scrutinizer 9ead02cb
- [TASK] Drop travis ci 7cc94a7b

## BUGFIX

- [BUGFIX] Remove obsolete/invalid replacements in composer.json d7e03885
- [BUGFIX] htaccess does not allow pages that end with "rc" - fixes #652 9415bf00
- [BUGFIX] Render data-interval only on carousel if value exists 7597b2ed

## MISC

- [SECURITY] Ensure content element subheader is HTML encoded 385777a4
...
- [FEATURE] Add typoscript condition to check typo3 core version b8c94c00

## TASK

- [TASK] Use youtube-nocookie url in external media utility bf54c97d

## BUGFIX

- [BUGFIX] Use .typoscript fileeindng for configuratio files in TYPO3 >= 9.3 for external includes fef134f0
- [BUGFIX] Use correct accordion_item language label in Backend.xlf (#490) 344cc198
