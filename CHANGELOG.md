...
- [TASK] Add ddev setup 8f50e180
- [TASK] Drop scrutinizer 8d56b97e
- [TASK] Drop travis ci 6d978c8d

## BUGFIX

- [BUGFIX] Remove obsolete/invalid replacements in composer.json b20051fb
- [BUGFIX] htaccess does not allow pages that end with "rc" - fixes #652 5a1edccf
- [BUGFIX] Render data-interval only on carousel if value exists 39122fcc

## MISC

- [SECURITY] Ensure content element subheader is HTML encoded 4796e779
...
- [FEATURE] Add typoscript condition to check typo3 core version 7059c12b

## TASK

- [TASK] Use youtube-nocookie url in external media utility 0a71eb26

## BUGFIX

- [BUGFIX] Use .typoscript fileeindng for configuratio files in TYPO3 >= 9.3 for external includes 1a7ad716
- [BUGFIX] Use correct accordion_item language label in Backend.xlf (#490) 99fc30cf

# 9.0.1

## BREAKING

- [!!!][BUGFIX] Make DataRelationViewHelper compatible with doctrine. 5c554ac8

## TASK

- [TASK] Move CMS9 backend branding to service that is only called on installation 1d479f92
- [TASK] Move icon registration to localconf 4a49fa08
- [TASK] Exclude php less libary from extension scanner 144c4f6c
- [TASK] Remove correct addStaticFile function from extension scanner 2a0c745d

## BUGFIX

- [!!!][BUGFIX] Make DataRelationViewHelper compatible with doctrine. 5c554ac8
- [BUGFIX] Ensure page layout class is never empty 20709de1
