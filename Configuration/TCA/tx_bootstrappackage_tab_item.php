...
return [
    ...
    'columns' => [
        'tt_content' => TcaUtility::getContentElementRelation(
            'LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:tab_item.tt_content',
            'CType',
            ['tab']
        ),
        ...
        'mediaorient' => TcaUtility::getOptions(
            ...
            [
                ['LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:tab_item.mediaorient.left', 'left'],
                ['LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:tab_item.mediaorient.top', 'top'],
                ['LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:tab_item.mediaorient.right', 'right'],
                ['LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:tab_item.mediaorient.bottom', 'bottom'],
            ],
            'left'
        ),
        'imagecols' => TcaUtility::getOptions(
            'LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:tab_item.imagecols',
            [
                ['1', 1],
                ['2', 2],
                ['3', 3],
        ...
        'image_zoom' => TcaUtility::getToggle('LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:tab_item.image_zoom'),
    ],
];
